...
public class EnchantmentSafeFall extends EnchantmentWand implements ICastable {

	protected final int MIN_LEVEL = 1;
	protected final int MAX_LEVEL = 5;
	private final String enchantmentName = "Safe Fall";
	
	public EnchantmentSafeFall(int id, int weight) {
		super(id, weight, EnumWandElement.AIR);
		this.setName("safeFall");
	}

	public int cast(ItemStack stack, World world, EntityLiving entity, int level, int charge) {
		System.out.println("Safe Fall Cast");
		return 1;
	}
