...
public class EnchantmentVortex extends EnchantmentWand implements ICastable {

	protected final int MIN_LEVEL = 1;
	protected final int MAX_LEVEL = 5;
	private final String enchantmentName = "Vortex";
	
	public EnchantmentVortex(int id, int weight) {
		super(id, weight, EnumWandElement.AIR);
		this.setName("vortex");
	}

	public int cast(ItemStack stack, World world, EntityLiving entity, int level, int charge) {
		System.out.println("Vortex Cast");
		return 1;
	}
