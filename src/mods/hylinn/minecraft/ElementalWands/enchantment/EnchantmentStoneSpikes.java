...
public class EnchantmentStoneSpikes extends EnchantmentWand implements
		ICastable {

	protected final int MIN_LEVEL = 1;
	protected final int MAX_LEVEL = 5;
	private final String enchantmentName = "Stone Spikes";
	
	public EnchantmentStoneSpikes(int id, int weight) {
		super(id, weight, EnumWandElement.EARTH);
		this.setName("stoneSpikes");
	}

	public int cast(ItemStack stack, World world, EntityLiving entity, int level, int charge) {
		System.out.println("Stone Spikes Cast");
		return 1;
	}
