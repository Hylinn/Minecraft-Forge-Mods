...
public class EnchantmentEntangle extends EnchantmentWand implements ICastable {

	protected final int MIN_LEVEL = 1;
	protected final int MAX_LEVEL = 5;
	private final String enchantmentName = "Entangle";
	
	public EnchantmentEntangle(int id, int weight) {
		super(id, weight, EnumWandElement.EARTH);
		this.setName("entangle");
	}

	public int cast(ItemStack stack, World world, EntityLiving entity, int level, int charge) {
		System.out.println("Entangle Cast");
		return 1;
	}
