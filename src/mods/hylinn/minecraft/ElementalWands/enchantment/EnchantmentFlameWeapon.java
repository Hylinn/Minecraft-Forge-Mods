...
public class EnchantmentFlameWeapon extends EnchantmentWand implements ICastable{

	protected final int MIN_LEVEL = 1;
	protected final int MAX_LEVEL = 5;
	private final String enchantmentName = "Flame Weapon";
	
	public EnchantmentFlameWeapon(int id, int weight) {
		super(id, weight, EnumWandElement.FIRE);
		this.setName("flameWeapon");
	}

	public int cast(ItemStack stack, World world, EntityLiving entity, int level, int charge) {
		System.out.println("Flame Weapon Cast");
		return 1;
	}
