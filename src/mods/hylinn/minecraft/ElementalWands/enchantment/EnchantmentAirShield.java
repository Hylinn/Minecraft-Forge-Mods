...
public class EnchantmentAirShield extends EnchantmentWand implements ICastable {

	protected final int MIN_LEVEL = 1;
	protected final int MAX_LEVEL = 5;
	private final String enchantmentName = "Air Shield";
	
	public EnchantmentAirShield(int id, int weight) {
		super(id, weight, EnumWandElement.AIR);
		this.setName("airShield");
	}

	public int cast(ItemStack stack, World world, EntityLiving entity, int level, int charge) {
		System.out.println("Air Shield Cast");
		return 1;
	}
